...
$ns duplex-link $A $B 100Kb 100ms DropTail
$ns duplex-link $B $C 100Kb 100ms DropTail
$ns duplex-link $C $D 100Kb 100ms DropTail
$ns duplex-link $D $E 100Kb 100ms DropTail
$ns duplex-link $E $F 100Kb 100ms DropTail
$ns duplex-link $F $A 100Kb 100ms DropTail
$ns duplex-link $A $G 100Kb 100ms DropTail
$ns duplex-link $G $F 100Kb 100ms DropTail
$ns duplex-link $G $D 100Kb 100ms DropTail
...
$ns rtmodel-at 1.0 down $A $G
#la secunda 2 legatura n1 n2 revine
$ns rtmodel-at 2.0 up $A $G
